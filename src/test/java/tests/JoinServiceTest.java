...
public class JoinServiceTest {
    ...
    void joinSuccessByRequest(){
        ...
        given(request.getParameter("confirmUserId")).willReturn(member.getConfirmUserPw());
    ...
    @Test
    @DisplayName("아이디(6자리 이상), 비밀번호(8자리 이상) 최소 자리수 체크, 실패 시 BadRequestException 발생")
    ...
    @Test
    @DisplayName("비밀번호와 비밀번호 확인 입력 데이터 일치 여부 체크, 검증 실패 시 BadRequestException 발생")
